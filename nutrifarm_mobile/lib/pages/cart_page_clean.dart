...
class _CartPageState extends State<CartPage> {
  ...
  String _fmt(num v) {
    ...
    for (int i = 0; i < s.length; i++) {
      final ri = s.length - i - 1;
      b.write(s[i]);
      if (ri % 3 == 0 && i != s.length - 1) b.write('.');
    }
    return 'Rp$b';
  }
  ...
  Widget _buildCartItem(CartItem item, CartService cartService) {
    ...
    final effective = p.discountPrice ?? p.price;
    final discountPercent = hasDiscount ? (((p.price - effective) / p.price) * 100).round().clamp(1, 99) : null;
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: hasDiscount ? Colors.red : Colors.grey[400],
                ...
                Row(
                  children: [
                    ...
                    Text(
                      hasDiscount ? 'Hemat $discountPercent%' : 'Promo menarik',
                      style: GoogleFonts.nunitoSans(
                        fontSize: 12,
                        color: Colors.orange[700],
                        fontWeight: FontWeight.w500,
  ...
  Widget _buildCheckoutSection(CartService cartService) {
    ...
    final savings = cartService.totalSavings;
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
