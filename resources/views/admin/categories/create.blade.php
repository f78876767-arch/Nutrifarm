        ...
        <form method="POST" action="{{ route('admin.categories.store') }}">
            ...
            <div class="mb-4">
                ...
                <textarea id="meta_description" name="meta_description" rows="3"
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('meta_description') border-red-500 @enderror">{{ old('meta_description') }}</textarea>
