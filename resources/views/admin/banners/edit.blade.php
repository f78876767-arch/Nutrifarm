            ...
            <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <img src="{{ $banner->image_url }}" alt="{{ $banner->title }}" 
                                 class="max-w-md max-h-48 rounded-lg shadow border">
                        </div>
                    </div>
                @endif
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $banner->image_url ? 'Replace Banner Image' : 'Banner Image' }}
                        @if(!$banner->image_url) <span class="text-red-500">*</span> @endif
                    </label>
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-primary-600 hover:text-primary-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500">
                                    <span>{{ $banner->image_url ? 'Upload new file' : 'Upload a file' }}</span>
                                    <input id="image" name="image" type="file" class="sr-only" accept="image/*" {{ !$banner->image_url ? 'required' : '' }}>
                                </label>
                ...
                <div>
                    ...
                    <input type="text" name="action_url" id="action_url" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                           placeholder="nutrifarm://category/organic" value="{{ old('action_url', $banner->action_url) }}">
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" min="0"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500"
                           placeholder="0" value="{{ old('sort_order', $banner->sort_order) }}" required>
